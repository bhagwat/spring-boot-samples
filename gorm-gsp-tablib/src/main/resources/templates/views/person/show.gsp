...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><a class="create" href="/person/create">New</a></li>
    </ul>
</div>
...
<div id="show-person" class="content scaffold-show" role="main">
    ...
    <ol class="property-list person">
        ...
        <g:if test="${personInstance?.age}">
            <li class="fieldcontain">
                <span id="voting-label" class="property-label">Eligible for voting</span>

                <span class="property-value" aria-labelledby="voting-label">
                    <app:eligibleForVoting age="${personInstance.age}"/>
                </span>
            </li>
        </g:if>
    </ol>
